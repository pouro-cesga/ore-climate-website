#ATS #HPC
This provides guidance on how to install ATS on UoU CHPC system. It mostly follows [[2021-03-09-Compile-ATS-Master-on-Linux]] with a few modifications.
...
## Installation
This is the same as in [[2021-03-09-Compile-ATS-Master-on-Linux]].
...
- Modulefile template
Module file starts with `#%Module`.  See [here](https://lmod.readthedocs.io/en/latest/060_locating.html) to set default module.
